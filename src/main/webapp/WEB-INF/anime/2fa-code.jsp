    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-6 col-md-8 col-sm-10 col-xs-12" >
                ...
                <form method="post" action="${appURL}/2fa-code">
                    <div class="mb-4">
                    ...
                    <div class="align-items-center mt-0">
                        <div class="d-grid">
                            <button class="btn btn-darkred mb-0" type="submit">Confirm</button>
                        </div>
                    </div>
                </form>
                <div class="text-center">
                    <p>Didn't receive the code? <a href="${appURL}/2fa-code?resend">Resend</a></p>
                </div>
            </div>
        </div>
    </div>
