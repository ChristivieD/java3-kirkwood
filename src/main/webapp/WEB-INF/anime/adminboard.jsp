                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="mb-0 ms-2">
                                                <h6><a href="${appURL}/users">See All Users</a></h6>
                                                <h6><a href="${appURL}/animeList">List of Anime</a></h6>
                                                <h6><a href="${appURL}/comingSoon">UpComing Anime</a></h6>
                                                <h6><a href="${appURL}/animeAdding">Add an Anime</a></h6>
                                                <h6><a href="${appURL}/deleteAnime">Delete an Anime</a></h6>
                                                <h6><a href="${appURL}/details">See All Reviews</a></h6>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
