                                    ...
                                    <div class="row g-0">
                                        ...
                                        <div class="col-md-7">
                                            <div class="card-body">
                                                ...
                                                <!-- Title -->
                                                <h5 class="card-title"><a href="#" data-bs-togglr="modal" data-bs-target="#courseModal${course.id}">${course.name}</a></h5>
                                ...
                                <div class="card card-body shadow p-4 mb-4">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xxl-6">
                                            ...
                                            <!-- Checkbox -->
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="category" value="${categories[4].id}" id="flexCheckDefault17">
                                                <label class="form-check-label" for="flexCheckDefault17">${categories[4].name}(${categories[4].numCourses}</label>
                                            </div>
                                        </div>
