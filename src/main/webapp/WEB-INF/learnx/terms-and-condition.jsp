    ...
    <div class="container">
        <div class="row justify content center">
            <div class="col-lg-10 col-md-12">
                ...
                <hr class="py-2">
                <h3>Introduction</h3>
                <p>Welcome to LearnX! These terms and conditions outline the rules and regulations
                    for the use of LearnX.</p>
                <h3>User Accounts</h3>
                <p>You may be required to create an account to access certain features of the Website or Service.
                ...
                <p>If you have any questions about these Terms, please contact us at
                    <a href="mailto:LearnX@gmail.com">LearnX@gmail.com</a>.</p>
            </div>
        </div>
    </div>
</main>
